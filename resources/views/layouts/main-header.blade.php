								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{ url('/' . $page='markAsRead_all') }}">تعين قراءة الكل</a></span>
										</div>
                                    ...
                                    <div id="unreadNotifications">
                                        ...
                                        <div class="main-notification-list Notification-scroll">
                                            <a class="d-flex p-3 border-bottom" href="{{url('markAsRead')}}/{{$notification->id}}/{{$notification->data['id']}}">
